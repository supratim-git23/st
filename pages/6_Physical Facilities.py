...
# Load data
df = pd.read_csv("https://kolkatassm.in/dataVisu/pf.csv")
...
years = [2023, 2024]
base_metrics = ['Furniture', 'Kitchen-shed', 'Dining-hall', 'Ramps', 'Playground', 'Electricity', 'Boundary-wall', 'Cwsn-toilet']
...
# Layout
fig.update_layout(
    title=f"Physical Facilities {circle_name} and District Average (2023-24[2023] vs (2024-25[2024])",
