...
# Load data
df = pd.read_csv("https://kolkatassm.in/dataVisu/Cat_ptr.csv")
...
years = [2023, 2024]
base_metrics = ['PRI-PTR','UP-PTR','SEC-PTR','HS-PTR']
...
# Layout
fig.update_layout(
    title=f"PTR according to school category {circle_name} and District Average (2023-24[2023] vs (2024-25[2024])",
