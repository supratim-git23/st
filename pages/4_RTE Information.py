...
# Load data
df = pd.read_csv("https://kolkatassm.in/dataVisu/ftb.csv")
...
years = [2023, 2024]
base_metrics = ['FTB','Uniform','HT-ROOM-PRI','HT-ROOM-UPSECHS']
...
# Layout
fig.update_layout(
    title=f"RTE related Information {circle_name} and District Average (2023-24[2023] vs (2024-25[2024])",
