...
# Load data
df = pd.read_csv("https://kolkatassm.in/dataVisu/enr_range_tch_range.csv")
...
years = [2023, 2024]
base_metrics = ['Zero-enr','Enrolment-less-15','Enrolment-less-30','Zero-teacher','One-teacher']
...
# Layout
fig.update_layout(
    title=f"Area of Concern {circle_name} and District Average (2023-24[2023] vs (2024-25[2024])",
