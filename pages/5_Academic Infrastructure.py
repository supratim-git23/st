...
# Load data
df = pd.read_csv("https://kolkatassm.in/dataVisu/ict.csv")
...
base_metrics = ['ICT-Lab','Having-computer','Internet-faciity-pedagogy','Integrated-Sc-Lab']
...
# Layout
fig.update_layout(
    title=f"Academic(digital) Facilities {circle_name} and District Average (2023-24[2023] vs (2024-25[2024])",
