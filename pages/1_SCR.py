...
# Load data
df = pd.read_csv("https://kolkatassm.in/dataVisu/Cat_scr.csv")
...
years = [2023, 2024]
base_metrics = ['PRI-SCR','UP-SCR','SEC-SCR','HS-SCR']
...
# Layout
fig.update_layout(
    title=f"SCR according to school category {circle_name} and District Average (2023-24[2023] vs (2024-25[2024])",
